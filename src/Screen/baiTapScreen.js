...
function BaiTapScreen(props) {
  ...
  console.log("check data:", config.data);
  ...
  function selectType(type) {
    ...
    if (data.length > 0) {
      randomIndices.map((index) =>
        dataRandom.push(
          data[parseInt(index) - 1] ? data[parseInt(index) - 1] : 0,
        ),
      );
    }
    setType(type);
  ...
  return (
    <>
      <div className="bg-white" style={{ minHeight: "80vh" }}>
        ...
        <div className="fluid-container mt-4 px-2">
          <div className="text-center pb-1">
            <div style={{ fontSize: "90px" }}>
              <div
                className="baitap-title c-lightRed  position-relative z-index-5"
            ...
            <div
              className="baitap-example c-darkBlue fw-bold text-center"
              style={{ fontSize: "50px" }}
            >
              Bài tập
            </div>
            <div
              className="baitap-content c-darkBlue fw-light fst-italic text-center"
              style={{ fontSize: "30px" }}
            >
          ...
          <div className="">
            <div className="container text-white">
              ...
              >
                ...
                >
                  <div
                    className={`text-bold ${Type == 1 ? "bg-darkBlue" : "bg-lightBlue"
                ...
                >
                  <div
                    className={`text-bold ${Type == 2 ? "bg-darkBlue" : "bg-lightBlue"
                      }  hover-darkBlue py-4 fw-bold ps-5 hover-mouse h-100 rounded-pill`}
                  >
            ...
            <div className="container text-white">
              ...
              >
                ...
                >
                  <div
                    className={`text-bold ${Type == 3 ? "bg-darkBlue" : "bg-lightBlue"
                      }  hover-darkBlue py-4 fw-bold ps-5 hover-mouse h-100 rounded-pill`}
                  >
                ...
                >
                  <div
                    className={`text-bold ${Type == 4 ? "bg-darkBlue" : "bg-lightBlue"
                      }  hover-darkBlue py-4 fw-bold ps-5 hover-mouse h-100 rounded-pill`}
                  >
                          ...
                          <div>
                            {question[Type * 2] && (
                              <>
                                ...
                                >
                                  (Trả lời dưới dạng phiên âm của chữ Hán)
                                </div>
                                <div>
                                  {index + 1}.{" "}
                                  {question[Type * 2]
                      ...
                      <div className="b-darkBlue border-4 px-3 py-2 rounded">
                        ...
                        {Check ? (
                          <div>
                            {responses[question[0]] &&
                              ...
                              <input
                                ...
                                name={`question_${question[0]}`}
                                className="p-2  my-3"
                                // value={responses[question_question[0]]}
                                value={responses[question[0]]}
                                onChange={(e) =>
                                  handleInputChange(question[0], e.target.value)
                                }
                          ...
                          <div className="col-3">
                            ...
                            >
                              <option value="对" style={{ fontWeight: "600" }}>
                                ...
                              </option>
                              <option value="对" style={{ fontWeight: "600" }}>
                                对
                              </option>
                              <option value="错" style={{ fontWeight: "600" }}>
                                错
                              </option>
                            </select>
                            {/* <input
